...
var_list <- as.data.frame(Risk_tbl)[c(Vars),2]
...
In total, `r F.disc_rows` records were returned for `r topic` (`r var_list`).    
...
2x2 contingency table for `r topic` and activity mat_well_4.
